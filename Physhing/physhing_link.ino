...
const char* ssid = "MASUM"; // MAIN WIFI SSID
const char* password = "1234567890"; // MAIN WIFI PASS

const char* ap_ssid = "FREE=12345678"; // CREAT SSID
const char* ap_password = "12345678"; //CREAT PASS
